...
Below is a prompt to create lecture content for a topic specific lecture session relating to the Kotlin programming language.
...
This lecture content will follow (guided by) the attached lecture slide content: `Codesmellsandrefactoring.pdf` - with the functions content coming first. 
...
Provide snippets of sample output for each program where appropriate.
...
* a table of contents with links to sections/topics 
* a learning outcomes section listing what learners will be able to do by the end of the lecture

* Do not mention pre-requisites or preparation for future lectures (or similar)
* Do  not show time aollocations for each section
"
