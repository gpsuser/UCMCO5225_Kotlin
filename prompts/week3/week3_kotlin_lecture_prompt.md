...
Here is a prompt to create lecture content for a lecture session on `kotlin` programming, specifically covering the topics of Inheritance and the Liskov Substitution Principle (LSP) in Object-Oriented Programming (OOP).
...
This lecture content will follow (guided by) the attached lecture slide content: `2.5. Inheritance.pdf` and `3.5. OOP Principles LSP.pdf` - with the functions content coming first. 
